...
getEvolutionTableData <- function() {
  filterEvolutionTableRows <- function(data) {
    ...
    if (addAdditionalStrategy == 1) {
      ...
      stop(paste0("Invalid addAdditionalStrategy: ", addAdditionalStrategy))
    }
