...
getEvolutionStats <- function() {
  ...
  for (statsKey in names(evolutionStatsParams)) {
    ...
    if (paired) {
      ...
      mainTest <- c(mainTest, stats[["test_methods"]])
      ...
      alternativeTest <- c(alternativeTest, stats[["other_binary_test_methods"]])
      ...
      mainTest <- c(mainTest, stats[["significance.test"]])
      ...
      alternativeTest <- c(alternativeTest, rep("–", nrow(stats)))
  ...
  evolution_stats <- data.frame(questionTitle, uni, year, comparison, firstQuestionId, secondQuestionId, isPaired, isBinary, pValue, mainTest, effectSize, effectSizeInterpretation, values, alternativePValue, alternativeTest, alternativeEffectSize, alternativeEffectSizeInterpretation)
