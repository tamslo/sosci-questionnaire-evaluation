...
binary_evolutions$pValueDiff <- ifelse(
...
View(binary_evolutions[which(binary_evolutions$pValueDiff > 0),])
# TODO: Use McNemar as main test (maybe explicitly main p value with string which test and additionally McNemar and Wilcoxon)
```
